...
function GitContributions({rahulgope45}) {
  ...
  return (
    <div className="mx-auto my-8 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-4xl overflow-x-auto text-white">
